export default {
  ...
  pluginDescription: "Demandez des films et series via Jellyseerr. Decouvrez du contenu, demandez en 1 clic, suivez vos demandes.",
  ...
  testButton: "Tester",
  apiKeyLabel: "Cle API",
  apiKeyPlaceholder: "Cle API Jellyseerr",
